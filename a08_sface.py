...
parser.add_argument('--target', '-t', type=str, default='/home/jiwon/smart_city/data/jiwon.jpg',
                    help='Usage: Set path to the input image 1 (target face).')
parser.add_argument('--query', '-q', type=str, default='/home/jiwon/smart_city/data/face/01.jpg',
                    help='Usage: Set path to the input image 2 (query).')
parser.add_argument('--model', '-m', type=str, default='/home/jiwon/smart_city/data/face_recognition_sface_2021dec.onnx',
...
def visualize(img1, faces1, img2, faces2, matches, scores, target_size=[512, 512]): # target_size: (h, w)
    out1 = img1.copy()
    out2 = img2.copy()
    matched_box_color = (0, 255, 0)    # BGR 녹색
    mismatched_box_color = (0, 0, 255) # BGR 빨간색
...
if __name__ == '__main__':
    ...
    detector = YuNet(modelPath='/home/jiwon/smart_city/data/face_detection_yunet_2023mar.onnx',
                     inputSize=[320, 320],
                     confThreshold=0.9,
                     nmsThreshold=0.3,
                     topK=5000,
