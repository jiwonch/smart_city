...
parser.add_argument('--model', '-m', type=str, default='/home/jiwon/smart_city/data/handpose_estimation_mediapipe_2023feb.onnx',
...
if __name__ == '__main__':
    ...
    # palm detector
    palm_detector = MPPalmDet(modelPath='/home/jiwon/smart_city/data/palm_detection_mediapipe_2023feb.onnx',
                              nmsThreshold=0.3,
                              scoreThreshold=0.6,
    ...
    if args.input is not None:
        ...
        while cv.waitKey(1) < 0:
            ...
            if len(palms) == 0:
                ...
                # print('Palm detected!')
                cv.putText(frame, 'FPS: {:.2f}'.format(tm.getFPS()), (0, 30), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255))
        ...
        print(f"average inference time: {1000/np.mean(fps_list):.2f} ms")