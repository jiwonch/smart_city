...
parser.add_argument('--input', '-i', type=str, default='/home/jiwon/smart_city/data/vtest.avi',
                    help='Usage: Set path to the input video. Omit for using default camera.')
parser.add_argument('--model_path', type=str, default='/home/jiwon/smart_city/data/object_tracking_vittrack_2023sep.onnx',
